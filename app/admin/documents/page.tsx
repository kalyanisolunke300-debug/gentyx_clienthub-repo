...
export default function AdminDocumentsPage() {
  ...
  //   // only CLIENT is supported for now
  //   if (uploadRole !== "CLIENT") {
  //     toast({
  //       title: "Not supported yet",
  //       description:
  //         "Uploading for Service Center / CPA is not implemented yet. Please select a client.",
  //       variant: "destructive",
  //     });
  //     return;
  //   }
  ...
  //   const fileType =
  //     uploadDocType || (uploadFile ? detectFileType(uploadFile) : "OTHER");

  //   try {
  //     const formData = new FormData();
  //     formData.append("file", uploadFile);
  //     formData.append("clientId", uploadUser); // client_id
